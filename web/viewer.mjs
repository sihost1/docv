...
class SignatureManager {
  ...
  #add() {
    ...
    this.#currentEditor.addSignature(data, 40, this.#description.value);
...
{
  const HOSTED_VIEWER_ORIGINS = ["null", "http://sihost1.github.io", "https://sihost1.github.io"];
...
const pdfjsVersion = "5.0.127";
const pdfjsBuild = "d88035525";
const AppConstants = {
